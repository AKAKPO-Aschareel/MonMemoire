...
ray_Out_rot=ricChan(Tx_Frame_Final_rot.');
...
channel_rot = sum(((sym_recu_estim_rot)./(sym_estim_rot)),2)/n_estim;  % 1 moyennecolonne/C 2 LIGNE/L Réponse fréquentielle du canal pour les Nsp Symboles pilotes
